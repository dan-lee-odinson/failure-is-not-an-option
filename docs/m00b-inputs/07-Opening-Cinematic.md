...
**Status:** Updated 7 September 2026 for confirmed directions 18 and 19. The opening flow is specified for M00b; the revised engineering hero title studies await Dan’s selection; see direction 21. This remains a treatment, not an edited film or a verified shot list.
...
Current title studies are in `art/title-hero-v003/`: **A — Engineering block (recommended)** and **B — Wide opening line**. [Direction 21](21-Direction-Engineering-Hero-Title.md) supersedes the earlier v002 title typography and hierarchy: bold Chakra Petch lettering dominates a dedicated hero frame before menu controls appear. These revised studies use the approved room. Final artwork uses the accepted dramatic 2D room with its Glen-head safe area and the approved original emblem. The title is a live layout; menu keys are native controls with label-free SVG backgrounds. The Apollo/Modern setting is an interface theme, not a campaign mechanic. Only Apollo ships in M00b.
