...
No NASA insignia, worm logotype, or seal appears in any generated asset. The placeholder images in `assets/` are labeled flat rectangles generated by `npm run placeholders`.
